...
import { ChevronDown, ChevronRight, CircleHelp, Database as DatabaseIcon, FilePlus2, Heart, Home, LogOut, Menu, Plus, Search, Settings, X } from 'lucide-react'
