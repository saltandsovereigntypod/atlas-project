...
export type PageBlockType = 'heading' | 'text' | 'image' | 'database_view' | 'divider' | 'callout'
...
export interface Page { id: string; workspace_id: string; title: string; icon: string | null; cover: string | null; position: number; created_at: string; updated_at: string }
